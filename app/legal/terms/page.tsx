...
export default function TermsPage() {
  return (
    <div className="min-h-screen bg-white text-gray-700 py-16 px-4 font-cairo" dir="ltr">
      <div className="mx-auto" style={{ maxWidth: '800px' }}>
        ...
        {/* Legal Notice */}
        <div className="mt-16 pt-8 border-t border-gray-200 text-xs text-gray-600 space-y-1">
