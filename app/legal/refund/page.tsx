        ...
        <div className="space-y-10 text-[15px] leading-[1.95]">
          ...
          <section>
            <h2 className="text-xl font-bold text-[#C5A04E] mb-3">
              1. المبدأ : تنفيذ فوري للطلب، بدون حق في التراجع
            </h2>
            <p>منتجات ECOMY هي محتوى رقمي (تكوين بالفيديو) وخدمات شخصية (جلسة تشخيص).</p>
            <p className="mt-3">بتأكيد الطلب، يطلب العميل صراحةً بدء تنفيذ الخدمة فوراً <strong className="text-white font-bold">ويتنازل صراحةً عن حقه في التراجع</strong>، طبقاً للمادة L221-28 من قانون الاستهلاك الفرنسي. يبدأ تنفيذ الطلب بمجرد تأكيد الدفع، وتُرسل بيانات الدخول خلال 24 ساعة كحد أقصى. بمجرد فتح الوصول إلى المحتوى الرقمي، لا يمكن طلب أي استرجاع.</p>
          </section>
