            ...
            <div className="container mx-auto max-w-4xl">
                ...
                <div className="prose prose-invert max-w-none space-y-8 text-gray-600 font-cairo">
                    ...
                    <section>
                        ...
                        <h3 className="text-xl font-bold text-gray-900 mb-2">2.1 بيانات التعريف</h3>
                        ...
                        <h3 className="text-xl font-bold text-gray-900 mb-2 mt-4">2.2 بيانات الاستخدام</h3>
                        <ul className="list-disc list-inside space-y-2">
                        ...
                        <h3 className="text-xl font-bold text-gray-900 mb-2 mt-4">2.3 بيانات الدفع</h3>
                        <p>
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-gray-900 mb-4">4. الأساس القانوني للمعالجة</h2>
                        <ul className="list-disc list-inside space-y-2">
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-gray-900 mb-4">6. أمن البيانات</h2>
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-gray-900 mb-4">7. مدة الاحتفاظ بالبيانات</h2>
                        <ul className="list-disc list-inside space-y-2">
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-gray-900 mb-4">10. نقل البيانات الدولي</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-gray-900 mb-4">11. القُصّر</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-gray-900 mb-4">12. تعديلات على سياسة الخصوصية</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-gray-900 mb-4">13. الاتصال</h2>
