...
export default function StatCard({ title, value, icon: Icon, trend, trendUp, color = "#C5A04E" }: StatCardProps) {
    return (
        <Card className="hover:border-[#C5A04E]/30 transition-colors">
            <div className="flex items-start justify-between">
                ...
                <div
                    className="p-3 rounded-xl bg-[#1A1A1A] text-white"
