        ...
        <nav className="fixed top-0 w-full z-50 glass border-b border-white/10 h-20">
            <div className="container mx-auto px-4 h-full flex items-center justify-between">
                ...
                <div className="hidden md:block">
                    <button className="bg-gradient-to-r from-[#00d2ff] to-[#9d50bb] text-white px-6 py-2.5 rounded-full font-bold hover:shadow-[0_0_20px_rgba(0,210,255,0.5)] transition-all transform hover:scale-105">
                        احجز مكانك
                    </button>
                </div>
            ...
            {isOpen && (
                <div className="md:hidden absolute top-20 w-full glass border-b border-white/10 py-6 px-4 flex flex-col gap-4 text-center">
                    ...
                    <button className="bg-gradient-to-r from-[#00d2ff] to-[#9d50bb] text-white px-6 py-3 rounded-full font-bold mt-2">
                        احجز مكانك
                    </button>
                </div>
            )}
