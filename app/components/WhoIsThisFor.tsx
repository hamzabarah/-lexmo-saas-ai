            ...
            <div className="container mx-auto px-4 max-w-6xl relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
                    ...
                    <FadeIn delay={0.2} className="relative group">
                        ...
                        <div className="relative bg-[#f4f6f8]/50 border border-red-500/10 rounded-2xl p-8 h-full backdrop-blur-sm">
                    ...
                    <FadeIn delay={0.4} className="relative group">
                        ...
                        <div className="relative bg-[#f4f6f8]/50 border border-green-500/10 rounded-2xl p-8 h-full backdrop-blur-sm">
