        ...
        <section className="py-20 relative overflow-hidden bg-[#0A0A0A]">
            ...
            <div className="container mx-auto px-4 max-w-6xl relative z-10">
                <FadeIn className="text-center mb-16">
                    ...
                    <p className="text-xl text-gray-500">هذا البرنامج ليس مناسباً لك إذا...</p>
                </FadeIn>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
                    ...
                    <FadeIn delay={0.2} className="relative group">
                        ...
                        <div className="relative bg-[#111111]/50 border border-red-500/10 rounded-2xl p-8 h-full backdrop-blur-sm">
                    ...
                    <FadeIn delay={0.4} className="relative group">
                        ...
                        <div className="relative bg-[#111111]/50 border border-green-500/10 rounded-2xl p-8 h-full backdrop-blur-sm">
                ...
                <FadeIn delay={0.6} className="text-center mt-12 bg-[#1A1A1A] border border-[#C5A04E]/10 rounded-xl p-6 lg:w-fit mx-auto backdrop-blur-md">
                    <p className="text-xl lg:text-2xl font-bold text-white font-cairo">
                        إذا كنت من النوع الثاني، فمرحباً بك في عائلة <span className="text-[#C5A04E]">ECOMY</span> 🚀
                    </p>
                </FadeIn>
            </div>
        </section>
