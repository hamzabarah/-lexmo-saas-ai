...
export default function ForgotPasswordPage() {
    ...
    return (
        <Card className="w-full">
            <Link href="/#login" className="flex items-center gap-2 text-gray-500 hover:text-white mb-6 transition-colors text-sm">
                <ArrowLeft size={16} />
                عودة لتسجيل الدخول
            </Link>
                    ...
                    <div className="space-y-2">
                        <div className="relative">
                            <input
                                ...
                                className="w-full bg-[#0A0A0A] border border-[#C5A04E]/10 rounded-xl px-4 py-3 pl-10 focus:outline-none focus:border-[#C5A04E] transition-colors"
                            />
