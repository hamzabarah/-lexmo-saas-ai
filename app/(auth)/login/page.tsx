    ...
    return (
        <Card className="w-full">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                <div className="space-y-2">
                    ...
                    <div className="relative">
                        <input name="email" type="email" required placeholder="email@example.com" className="w-full bg-[#0A0A0A] border border-[#C5A04E]/10 rounded-xl px-4 py-3 pl-10 focus:outline-none focus:border-[#C5A04E] transition-colors" />
                ...
                <div className="space-y-2">
                    ...
                    <div className="relative">
                        <input name="password" type="password" required placeholder="أدخل كلمة المرور" className="w-full bg-[#0A0A0A] border border-[#C5A04E]/10 rounded-xl px-4 py-3 pl-10 focus:outline-none focus:border-[#C5A04E] transition-colors" />
            ...
            <div className="mt-4 text-center">
                <Link href="/forgot-password" className="text-sm text-gray-500 hover:text-[#C5A04E] transition-colors">
                    نسيت كلمة المرور؟
                </Link>
            </div>
        </Card>
