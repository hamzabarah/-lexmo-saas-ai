...
export const TESTIMONIALS: Testimonial[] = [
  ...
  { id: "sc-23", type: "screen", name: "رشيد", country: "🇨🇭", countryCode: "ch", result: "فتح متجره في فبراير — وفي مارس: أكثر من 50000$ (الهدف كان 20 ألف!)", image: "/images/preuves/temoignage-23.png", tags: ["gros-resultat"] },
  { id: "sc-24", type: "screen", name: "سفيان", country: "🇮🇹", countryCode: "it", result: "فشل في متجره الأول — المتجر الثاني: 50950€ في شهر، من سالير 1100€ في إيطاليا", image: "/images/preuves/temoignage-24.png", tags: ["sceptique-converti", "salarie-etudiant", "gros-resultat"], featured: true },
  ...
  { id: "sc-26", type: "screen", name: "وليد", country: "🇫🇷", countryCode: "fr", result: "شرى دورات من فرنسا وأمريكا بلا نتيجة — هنا: أكثر من 112 ألف يورو مبيعات (+51%)", image: "/images/preuves/temoignage-26.png", tags: ["sceptique-converti", "gros-resultat"], featured: true },
  ...
  { id: "sc-28", type: "screen", name: "نبيل", country: "🇲🇦", countryCode: "ma", result: "بداية الرحلة: أول 243€ من المبيعات — «التكوين متقون»", image: "/images/preuves/temoignage-28.png", tags: ["premiere-vente"] },
  ...
  { id: "sc-33", type: "screen", name: "إيمان", country: "🇳🇱", countryCode: "nl", result: "عراقية في هولندا — 56064$ في 11 يوم (+2600%)", image: "/images/preuves/temoignage-33.png", tags: ["gros-resultat"] },
  ...
  { id: "sc-35", type: "screen", name: "سامر", country: "🇨🇭", countryCode: "ch", result: "26303$ في يوم واحد — «هاد الرقم كنت أحلم فيه بالسنة»", image: "/images/preuves/temoignage-35.png", tags: ["gros-resultat"] },
  { id: "sc-36", type: "screen", name: "ياسمين", country: "🇧🇪", countryCode: "be", result: "جزائرية في بلجيكا — أكثر من 6000$ و87 طلبية في نهار واحد", image: "/images/preuves/temoignage-36.png", tags: ["gros-resultat"] },
  { id: "sc-37", type: "screen", name: "آمنة", country: "🇳🇱", countryCode: "nl", result: "تونسية في هولندا، أم — أكثر من 9000$ في أقل من 12 ساعة وقدمت استقالتها رسمياً", image: "/images/preuves/temoignage-37.png", tags: ["maman", "reconversion", "gros-resultat"], featured: true },
  { id: "sc-38", type: "screen", name: "لين", country: "🇬🇧", countryCode: "gb", result: "فلسطينية في لندن — 33687£ في 7 أيام من دارها", image: "/images/preuves/temoignage-38.png", tags: ["gros-resultat"], featured: true },
  { id: "sc-39", type: "screen", name: "سلمى", country: "🇫🇷", countryCode: "fr", result: "مغربية في فرنسا، أم — 33061€ في 9 أيام بعد سنوات من العمل الشاق", image: "/images/preuves/temoignage-39.png", tags: ["maman", "reconversion", "gros-resultat"] },
  { id: "sc-40", type: "screen", name: "رلى", country: "🇺🇸", countryCode: "us", result: "أردنية في أمريكا، أم وموظفة منهكة — 43000$ في 10 أيام من بيتها", image: "/images/preuves/temoignage-40.png", tags: ["maman", "salarie-etudiant", "gros-resultat"] },
  { id: "sc-41", type: "screen", name: "أمل", country: "🇺🇸", countryCode: "us", result: "سعودية في أمريكا، متجر بخور — 368172$ في شهر (أكبر نتيجة في المكتبة)", image: "/images/preuves/temoignage-41.png", tags: ["gros-resultat"], featured: true },
  { id: "sc-42", type: "screen", name: "جواهر", country: "🇮🇪", countryCode: "ie", result: "بحرينية في إيرلندا — 50184$ في أول يوم بعد الإطلاق", image: "/images/preuves/temoignage-42.png", tags: ["gros-resultat"] },
  { id: "sc-43", type: "screen", name: "خالد", country: "🇫🇮", countryCode: "fi", result: "مهندس عماني في فنلندا — 40962$ بعد شهر واحد من بداية التدريب", image: "/images/preuves/temoignage-43.png", tags: ["salarie-etudiant", "gros-resultat"] },
  { id: "sc-44", type: "screen", name: "راشد", country: "🇺🇸", countryCode: "us", result: "إماراتي، موظف بنك سابق — 44909$ في 11 يوم: «اليوم أنا صاحب مشروع، أنا حر»", image: "/images/preuves/temoignage-44.png", tags: ["reconversion", "gros-resultat"] },
  { id: "sc-45", type: "screen", name: "ريم", country: "🇦🇹", countryCode: "at", result: "يمنية لاجئة في النمسا — أكثر من 50000€ في 15 يوم من بيتها", image: "/images/preuves/temoignage-45.png", tags: ["reconversion", "gros-resultat"], featured: true },
  ...
  { id: "sc-47", type: "screen", name: "سامي", country: "🇬🇧", countryCode: "gb", result: "طالب لبناني في بريطانيا — 16950£ في يوم واحد وهو مركز في دراسته", image: "/images/preuves/temoignage-47.png", tags: ["salarie-etudiant", "gros-resultat"] },
  { id: "sc-48", type: "screen", name: "مريم", country: "🇺🇸", countryCode: "us", result: "قطرية في أمريكا، طالبة بدون خبرة — 186174$ في 8 أيام", image: "/images/preuves/temoignage-48.png", tags: ["salarie-etudiant", "gros-resultat"], featured: true },
